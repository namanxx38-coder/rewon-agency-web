  ...
  return (
    ...
    >
      <div className="container mx-auto flex flex-col items-center text-center px-4">
        ...
        <p className="max-w-3xl text-slate-400 md:text-xl">
          {description}
        </p>
        ...
        >
          {members.map((member, index) => (
            <motion.div
              key={index}
              className="absolute w-28 h-28 md:w-36 md:h-36 lg:w-44 lg:h-44 rounded-xl overflow-hidden shadow-lg border-2 border-white/10"
